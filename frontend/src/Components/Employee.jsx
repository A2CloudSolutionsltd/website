                ...
                <div className='adjust' >
                  ...
                  <div className='d-flex flex-column align-items-center pt-4'>
                    ...
                    <form className="row g-3 w-50" onSubmit={handleSubmit} name='form'>
                      ...
                      <div className="col-12">
      <label htmlFor="inputRole" className="form-label">Address</label>
      <input
        type="text"
        ...
        {suggestions.map((item, index) => (
          ...
          >
            {item.display_name}
                      ...
                      <div className="col-12">
                        ...
                        <input type="text" className="form-control" id="inputAddress" placeholder="Title" autoComplete='off'
          ...
          <div className='emloyee-list'>
            ...
            <div className='top-search'>
              <p>These are the employee profiles that have been saved in the database. You can see the employees listed below. <strong>The profile picture can only be updated by the employees</strong> in their profile portal. Once they update their profile picture, you'll be able to view it here.

                Each employee profile has two options: 'Edit' and 'Delete.' In the 'Edit' option, you can rename the employee, update their address, and modify their job role. On the other hand, in the 'Delete' option, you can permanently remove or delete the employee from the database. Please exercise caution when deleting an employee, as this action is irreversible</p>
              ...
              return <div key={index} >
                <div className='ListingAllEmployee'>
                  <div className='ListingAllEmployee-Left'>
                    ...
                    <img src={`http://localhost:8081/images/`+employee.image} alt='Image Missing' className='proimage' />
                    </div>
                   
                  </div>
                  <div className='ListingAllEmployee-Right'>
                  <strong><h2>{employee.name}</h2></strong>
                    <p>{employee.email}</p>
                    <label>Title :</label>
