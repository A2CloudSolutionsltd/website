...
function Edit() {
    const [data, setData] = useState({
      ...
      const handleSubmit = (event) => {
        ...
        axios.put('http://localhost:8081/update/' + encodedEmail, {
          role: data.role,
          name: data.name,
                            ...
                            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start" id="menu">
                                <li>
                                    <Link to="/CRUD-employee" className="nav-link text-truncate">
                                        <i classNameName="fs-4 bi-people"></i><span className="ms-1 d-none d-sm-inline">Manage Employee</span> </Link>
                                </li>
                                ...
                                <div className='adjust' >
                                    ...
                                    <div className='d-flex flex-column align-items-center pt-4'>
                                        ...
                                        <form className="row g-3 w-50" name='form' onSubmit={handleSubmit}>
                                            ...
                                            <p>
                                                You can use this page to update the information of an employee. Please provide the updated details for the employee's name, location, image, password, and contact information.
                                            </p>
                                            <p>
                                                <strong>Name:</strong> Enter the updated name of the employee.
                                            </p>
                                            <p>
                                                <strong>Location:</strong> Provide the updated location or address of the employee.
                                            </p>
                                            <p>
                                                <strong>Password:</strong> If you want to update the employee's password, provide the new password here.
                                            </p>
                                            <p>
                                                <strong>Role:</strong> If you want to update the employee's Job Role/Domain, provide the new Role here.
                                            </p>
                                            <p>
                                                <strong>Contact Information:</strong> Make sure to update the employee's contact information if necessary.
                                            </p>
                                            <p>
                                            ...
                                            <div className="col-12">
                                                ...
                                                <input type="text" className="form-control" id="inputName" placeholder='Enter Name' autoComplete='off'
                                                  onChange={e => setData({...data, name: e.target.value})} value={data.name}   name='name' required />
                                            </div>
                                            <div className="col-12">
                                                <label for="inputRole" className="form-label">Address</label>
                                                <input type="text" className="form-control" id="inputROle" placeholder="1234 Main St"     autoComplete='off'
                                                onChange={e => setData({...data, address: e.target.value})} value={data.address}    name='address' required/>
                                            </div>
                                            <div className="col-12">
                                                <label for="inputAddress" className="form-label">Job-Role</label>
                                                <input type="text" className="form-control" id="inputAddress" placeholder="Enter Role"     autoComplete='off'
                                                onChange={e => setData({...data, role: e.target.value})} value={data.role}    name='role' required/>
                                            </div>
                                            <div className="col-12">
